...
<head>
    ...
    <style>
        ...
        .cart-container { max-width: 900px; margin: 0 auto; border: 1px solid #eee; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.05); }
        ...
        .item-details h3 { margin: 0 0 5px 0; font-size: 1.1em; color: #333; }
        .item-details p { margin: 0; color: #666; font-size: 0.9em; }
        .item-price { font-weight: bold; color: #e74c3c; margin-top: 5px; }
        .item-quantity { display: flex; align-items: center; gap: 5px; }
        .item-quantity input { width: 50px; padding: 5px; text-align: center; border: 1px solid #ccc; border-radius: 4px; }
        .item-quantity button { background-color: #f0f0f0; border: 1px solid #ccc; padding: 5px 10px; cursor: pointer; border-radius: 4px; }
        .item-quantity button:hover { background-color: #e0e0e0; }
        .item-actions button { background-color: #dc3545; color: white; border: none; padding: 8px 12px; cursor: pointer; border-radius: 4px; transition: background-color 0.2s; }
        .item-actions button:hover { background-color: #c82333; }
        .cart-summary { text-align: right; margin-top: 30px; border-top: 1px solid #eee; padding-top: 20px; }
        .cart-summary h2 { margin: 0 0 15px 0; color: #333; }
        .cart-summary button { background-color: #28a745; color: white; border: none; padding: 12px 25px; font-size: 1.1em; cursor: pointer; border-radius: 5px; margin-top: 15px; transition: background-color 0.2s; }
        .cart-summary button:hover { background-color: #218838; }
        .message.success { color: green; margin-bottom: 15px; text-align: center; }
    </style>
</head>
<body>
